...
This project is a simple seesaw (teeter-totter) simulation built with HTML, CSS, and JavaScript. The goal of the project is to simulate the physical behavior of a seesaw by allowing users to add weights and observe how the plank tilts based on torque calculations.
...
The plank that rotates based on torque
...
One of the features I implemented was the use of the mousemove event, which allowed me to determine the exact position of the cursor. This helped calculate where the weight should be placed on the plank.
...
Because I chose not to use Bootstrap, positioning UI elements such as containers and log sections required more manual adjustments. I also encountered difficulties when trying to properly format and split text inside the log component.
...
All final design decisions, implementation choices, and debugging were performed and verified by me.
...
Implement functionality step by step instead of building everything at once
